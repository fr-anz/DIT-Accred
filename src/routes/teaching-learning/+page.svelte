<script>
	...
	let carouselIndex = $state(0); // Carousel index for Notable Alumni
	...
	<div class="compliance_block">
		...
		<div class="lifecycle_card">
			...
			<div class="lifecycle_timeline">
				...
				<div class="timeline_node">
					<div class="node_icon_wrapper">
						<Layers size={28} strokeWidth={1.5} class="node_icon" />
					</div>
			...
			<div class="allocation_list">
				...
				<div class="allocation_item">
					...
					<div class="progress_track">
						<div class="progress_bar maroon_bar" style="width: calc(78 / 167 * 100%);"></div>
					</div>
				</div>
				<!-- Category 2 -->
				<div class="allocation_item">
					...
					<div class="progress_track">
						<div class="progress_bar gold_bar" style="width: calc(42 / 167 * 100%);"></div>
					</div>
				</div>
				<!-- Category 3 -->
				<div class="allocation_item">
					...
					<div class="progress_track">
						<div class="progress_bar maroon_bar" style="width: calc(18 / 167 * 100%);"></div>
					</div>
				</div>
				<!-- Category 4 -->
				<div class="allocation_item">
					...
					<div class="progress_track">
						<div class="progress_bar gold_bar" style="width: calc(17 / 167 * 100%);"></div>
					</div>
				</div>
				<!-- Category 5 -->
				<div class="allocation_item">
					...
					<div class="progress_track">
						<div class="progress_bar maroon_bar" style="width: calc(12 / 167 * 100%);"></div>
					</div>
				</div>
			</div>
	...
	<div class="student_orgs_grid">
		...
		<div class="org_card" style="background-image: url('https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=600')">
			...
			<div class="org_content">
				...
				<p class="org_desc">Institute of Bachelors of Information Technology Studies</p>
			</div>
		</div>
		...
		<div class="org_card" style="background-image: url('https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&q=80&w=600')">
			...
			<div class="org_content">
				...
				<p class="org_desc">Academitech Research and Knowledge</p>
			</div>
		</div>
		...
		<div class="org_card" style="background-image: url('https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&q=80&w=600')">
			...
			<div class="org_content">
				...
				<p class="org_desc">Amazon Web Services Cloud Club - PUP</p>
			</div>
		</div>
		...
		<div class="org_card" style="background-image: url('https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&q=80&w=600')">
			...
			<div class="org_content">
				...
				<p class="org_desc">Cisco NetConnect PUP - Manila</p>
			</div>
		</div>
	</div>
</section>
					...
					{#each alumniList.slice(0, 3) as alum, i}
						...
						>
							...
							<div class="portrait_info">
								...
								<span class="alum_batch">{alum.batch.replace('Batch ', '')}</span>
							</div>
						</div>
					{/each}
				</div>
...
<style>
	...
	.lifecycle_bg_overlay {
		position: absolute;
		inset: 0;
		background: linear-gradient(135deg, rgba(92, 15, 22, 0.85) 0%, rgba(22, 5, 7, 0.95) 100%);
	}
	...
	.unit_allocation_card {
		background: #fff;
		border: 1.5px solid rgba(207, 168, 58, 0.4);
		border-radius: 20px;
	...
	.enhancement_tab_btn.active::after {
		transform: scaleX(1);
	}
	...
	.enhancement_card {
		background: #fdfdfc;
		border: 1px solid rgba(92, 15, 22, 0.15);
		border-radius: 12px;
		padding: 1.5rem;
		box-shadow: 0 4px 15px rgba(92, 15, 22, 0.02);
		transition: all 0.3s cubic-bezier(0.16, 1, 0.3, 1);
	}
	...
	.enhancement_card:hover {
		...
		box-shadow: 0 6px 20px rgba(207, 168, 58, 0.08);
	}
	...
	.alumni_portrait_card.highlighted {
		...
		border-color: var(--color-gold);
		box-shadow: 0 6px 20px rgba(207, 168, 58, 0.2);
		transform: scale(1.05);
	}
	...
	.alumni_portrait_card.highlighted .portrait_image_wrapper {
		border-color: var(--color-gold);
	}
